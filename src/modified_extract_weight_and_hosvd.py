...
model.load_weights('/content/drive/MyDrive/checkpoint_original_lpcnet_maybepodcast/lpcnet9_384_10_G16_120.h5')
...
tucker_tensor = tucker(tl.tensor(kernel_weight), rank=[5, 5, 2])
