...
class TTGRUCell(DropoutRNNCellMixin, base_layer.BaseRandomLayer):
    """Cell class for the Tensor-Train GRU layer.

    See [the Keras RNN API guide](https://www.tensorflow.org/guide/keras/rnn)
    for details about the usage of RNN API.

    See [Compressing Recurrent Neural Network with Tensor Train](https://arxiv.org/pdf/1705.08052.pdf) for details.
    

    This class processes one step within the whole time sequence input, whereas
    `TTGRU` processes the whole sequence.
